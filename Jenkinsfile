...
sh "sudo docker run -d -p 6379:6379 --name redis_db redis"
...
sh "sudo docker run -d --name v2.0-orange1 -p 8180:8180 -e app.version="v2.0-orange-node1" --link sboot_demo_pg:sboot_demo_pg --link redis_db:redis_db gcr.io/techlab-235821/sboot:v2.0-orange"
sh "sudo docker rm -f v1.0-blue2"
sh "sudo docker run -d --name v2.0-orange2 -p 8280:8180 -e app.version="v2.0-orange-node2"  -e liquibase.parameters.cleanupRun="true" --link sboot_demo_pg:sboot_demo_pg --link redis_db:redis_db gcr.io/techlab-235821/sboot:v2.0-orange"
